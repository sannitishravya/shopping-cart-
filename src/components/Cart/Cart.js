...
const Cart = ({cart, handleEmptyCart ,handleRemoveFromCart,handleUpdateCartQty}) => {
    ...
    const EmptyCart = ()=>(
        <Typography variant = "subtitle1"><Link to="/" className='=classes.link'>Cart feels Light</Link>!</Typography>
    );
    const FilledCart = ()=>(
        <>
            ...
            <div>
                ...
                <Button className={classes.checkoutButton} size="large" color="primary" type="button" variant ="contained">Checkout</Button>
            </div>
        </>
    )
